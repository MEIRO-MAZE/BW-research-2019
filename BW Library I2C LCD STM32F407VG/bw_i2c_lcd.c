...
// Diganti I2C lain, Karena Terpakai TPA(I2C1)
...
{
	PCF8574_Write(chr);
	delay_us(300);	// Butuh delay karena char error kalau terlalu cepat
}
...
//	I2C1_WriteByte_LCD(LCD_ADDRESS, EN_ON);
//
...
//	I2C1_WriteByte_LCD(LCD_ADDRESS, (LCDMask_Temp | EN_ON));
//
//	delay_us(100);
//
//	// Send Nible with EN OFF
//	I2C1_WriteByte_LCD(LCD_ADDRESS, (LCDMask_Temp & 0xFB));
//}
//
//// Sementara Gak Guna
...
////	cmd = I2C_ADDRESS << 1;
////	cmd = cmd | 0x01;
////	I2C1_WriteByte_LCD(I2C_ADDRESS, cmd);
////}
//
...
//	I2C1_WriteByte_LCD(LCD_ADDRESS, (LCDMask | RS_ON));
...
//	I2C1_WriteByte_LCD(LCD_ADDRESS, (LCDMask | RS_OFF));
//
