...
//float max(max_bottom,max_upper)
//float max_bottom[];
//int max_upper;
//{
//	float maximum = max_bottom[0];
//	float cmax;
//	for (cmax=0;cmax<max_upper;cmax++)
//	{
//		if (max_upper[cmax] > maximum)
//		{
//			maximum = max_upper[cmax];
//		}
//	}
//
//	return maximum;
...
//float min(min_bottom,min_upper)
//float min_bottom[];
//int min_upper;
//{
//	float minimum = min_bottom[0];
//	float cmin;
//	for (cmin=0;cmin<min_upper;cmin++)
//	{
//		if (min_bottom[cmin] < minimum)
//		{
//			minimum = min_bottom[cmin];
//		}
//	}
//
//	return minimum;
